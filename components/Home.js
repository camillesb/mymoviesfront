...
//Grâce à la mécanique du hook d’effet, 
//faites une requête vers le backend webservice afin de remplacer le tableau d’objet moviesData 
...
useEffect(() => {
 ...
 .then(data => {
  ...
  //  title: data.result.original_title,
  //  overview: data.result.overview,
  //  poster: data.result.poster_path,
  //  vote_count:  data.result.vote_count,
  //  vote_average:  data.result.vote_average
